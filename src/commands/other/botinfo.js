    ...
    async execute(interaction) {
        ...
        const embed = new MessageEmbed()
            ...
            .addFields(
                ...
                { name: "Code", value: "https://eckigerluca.com/darling/github", inline: true },
                { name: "Support", value: "There is the **Bot Support** on my [Server](https://eckigerluca.com/discord).\nBut you can also support **me** on [Patreon](https://patreon.com/eckigerluca) or [Ko-Fi](https://ko-fi.com/eckigerluca)", inline: false },
            )
            .setFooter({ text: "Ich mag Bananensaft", iconURL: eckigerluca_avatar })
